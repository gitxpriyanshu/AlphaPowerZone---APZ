                ...
                {loading && recentOrders.length === 0 && stats.totalOrders === 0 ? (
                    ...
                    <>
                        <div className="mb-8">
                            ...
                            <p className="text-gray-600">Manage your orders and shopping cart</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                            ...
                            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-shadow">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-3xl font-bold text-gray-900">{stats.cartItems}</p>
                                    </div>
                            ...
                            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-shadow">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-sm text-gray-600 mb-1">Total Cart Value</p>
                                        <p className="text-3xl font-bold text-green-600">₹{stats.cartTotal.toFixed(2)}</p>
                                    </div>
                                    <div className="bg-green-100 p-3 rounded-full">
                                        <svg className="w-8 h-8 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-primary transition-colors">View Cart</h3>
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-primary transition-colors">Browse Products</h3>
