        ...
        {loading && cartItems.length === 0 ? (
          ...
          <div className="text-center py-24 bg-white rounded-3xl shadow-xl border border-gray-100 max-w-2xl mx-auto px-6">
            ...
            <p className="text-gray-500 text-lg mb-10 max-w-md mx-auto">
              ...
              our premium collections and find something you'll love!
            </p>
            <button
              onClick={() => navigate("/")}
              ...
              <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
                <ul className="divide-y divide-gray-100">
                  {cartItems.map((item) => (
                    <li
                      key={item.id}
                      className="p-8 flex items-center hover:bg-gray-50/50 transition-all group"
                    >
                      ...
                      <div className="ml-8 flex-1 flex flex-col">
                        <div className="flex justify-between text-xl font-bold text-gray-900 mb-1">
                          <h3 className="hover:text-primary cursor-pointer transition-colors leading-tight">
                            {item.product.name}
                          </h3>
              ...
              <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 sticky top-24">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between text-lg text-gray-600">
                    ...
                    <span className="font-bold text-green-600 uppercase tracking-wider text-sm bg-green-50 px-3 py-1 rounded-full">
                      Free
                    </span>
                  </div>
