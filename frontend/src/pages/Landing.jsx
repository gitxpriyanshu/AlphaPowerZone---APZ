    ...
    <div className="min-h-screen bg-[#fafafa] flex flex-col font-sans overflow-x-hidden">
      ...
      <div className="relative h-[90vh] min-h-[600px] w-full flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-gray-300 mb-10 max-w-lg leading-relaxed animate-fade-in-up delay-200">
              Experience the pinnacle of fitness performance with APZ's
              exclusive gear. Engineered for those who never settle.
            </p>
            <div className="flex flex-wrap gap-4 animate-fade-in-up delay-300">
              <button
                onClick={() => navigate("/home")}
                className="group bg-primary hover:bg-indigo-700 text-white px-10 py-4 rounded-full font-bold shadow-2xl transition-all transform hover:-translate-y-1 flex items-center gap-2"
              >
                Enter Store
              ...
              <button
                onClick={() => navigate("/home")}
                className="bg-white/10 backdrop-blur-md border border-white/30 text-white hover:bg-white/20 px-10 py-4 rounded-full font-bold transition-all transform hover:-translate-y-1"
              >
                View Collections
              </button>
            </div>
        ...
        <div className="absolute right-10 bottom-10 flex flex-col items-center gap-4 animate-bounce opacity-50">
          <span className="text-white text-xs font-bold tracking-widest uppercase [writing-mode:vertical-rl]">
            Scroll
          </span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 flex-1">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div className="max-w-xl">
              ...
              <p className="text-gray-500 text-lg">
                Hand-picked categories to elevate your workout experience.
              </p>
            </div>
            <button
              onClick={() => navigate("/home")}
            ...
            {loading && categories.length === 0
              ...
              : categories.slice(0, 3).map((category, index) => (
                  <div
                    ...
                    className={`group cursor-pointer relative h-[500px] rounded-[2.5rem] overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-700 transform hover:-translate-y-2 ${
        ...
        <div id="products" className="mb-24">
          <div className="flex items-center justify-between mb-16">
            <div>
              <h2 className="text-5xl font-black text-gray-900 tracking-tight leading-tight mb-2">
                TRENDING NOW
              </h2>
                ...
                <div key={product.id} className="group flex flex-col">
                  ...
                  <div className="px-2">
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-xl font-bold text-gray-900 truncate pr-4 uppercase">
                        {product.name}
                      </h3>
      ...
      <div className="bg-gray-900 py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
            Get exclusive updates on new drops and membership-only offers.
          </p>
