...
export const verifyPayment = asyncHandler(async (req: Request, res: Response) => {
  ...
  return res.status(200).json(
    new ApiResponse(200, { orderId: order.id }, 'Payment verified successfully')
  );
});
...
export const createCODOrder = asyncHandler(async (req: Request, res: Response) => {
  ...
  return res.status(201).json(
    new ApiResponse(201, { orderId: order.id }, 'COD Order placed successfully')
  );
});

export const payExistingOrder = asyncHandler(async (req: Request, res: Response) => {
