 ...
 */
export const verifyOwnerJWT = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const decodedToken = jwt.verify(token, env.JWT_SECRET) as { id: string, role: string };
