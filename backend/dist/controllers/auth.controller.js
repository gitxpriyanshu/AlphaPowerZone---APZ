...
export const login = asyncHandler(async (req, res) => {
    ...
    const loggedInUser = { ...rest, role: 'user' };
    return res
        .status(200)
...
export const refreshAccessToken = asyncHandler(async (req, res) => {
    ...
    try {
        const decodedToken = jwt.verify(incomingRefreshToken, env.JWT_SECRET);
...
export const getProfile = asyncHandler(async (req, res) => {
    return res
        .status(200)
        .json(new ApiResponse(200, { ...req.user, role: 'user' }, 'User profile fetched successfully'));
});
export const updateProfile = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, { ...updatedUser, role: 'user' }, 'Profile updated successfully'));
});
